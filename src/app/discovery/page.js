    ...
    <div className="container mx-auto px-8  py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div className="relative bg-[#3fbeb2] shadow-md rounded-2xl flex flex-col justify-center items-center text-center h-80 transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-start items-center">
            <h4 className="text-xl font-bold text-white mb-5 uppercase mt-4">Step 1:</h4>
            <p className="text-white px-4">
            Discovery Party is an opportunity to connect with our church staff and hear more about the history, mission and vision of Refresh. 
            </p>
          </div>
        </div>

        {/* Step 2 */}
        <div className="relative bg-[#f39757] shadow-md rounded-2xl flex flex-col justify-center items-center text-center md:h-80 h-[350px] transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-start items-center">
            <h4 className="text-xl font-bold text-white mb-5 uppercase mt-4">Step 2:</h4>
            <p className="text-white px-4">
            Discovery Learning is an online assessment of your personality, spiritual gifts, and heart for ministry. It includes an online lesson series to help you understand how God wired you and how you can use that information to discover His purpose in your life.
            </p>
          </div>
        </div>

        {/* Step 3 */}
        <div className="relative bg-[#e46246] shadow-md rounded-2xl flex flex-col justify-center items-center text-center lg:h-80 md:h-96 h-[410px] transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-start items-center">
            <h4 className="text-xl font-bold text-white mb-5 uppercase mt-4">Step 3:</h4>
            <p className="text-white px-4">
        ...
        {/* Step 4 */}
        <div className="relative bg-[#315860] shadow-md rounded-2xl flex flex-col justify-center items-center text-center lg:h-80 md:h-96 h-[350px] transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-start items-center">
            <h4 className="text-xl font-bold text-white mb-5 uppercase mt-4">Step 4:</h4>
            <p className="text-white px-4">
