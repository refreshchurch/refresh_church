  ...
  return (
    <div className="container mx-auto px-8 sm:px-36 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
        {/* Step 1 */}
        <div className="relative bg-[#3fbeb2] shadow-md rounded-2xl flex flex-col justify-center items-center text-center h-64 transform transition-transform duration-300 hover:scale-105">
        ...
        {/* Step 2 */}
        <div  className="relative bg-[#f39757] shadow-md rounded-2xl flex flex-col justify-center items-center text-center h-64 transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-center items-center">
        ...
        {/* Step 3 */}
        <div className="relative bg-[#e46246] shadow-md rounded-2xl flex flex-col justify-center items-center text-center h-64 transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-center items-center">
        ...
        {/* Step 4 */}
        <div  className="relative bg-[#315860] shadow-md rounded-2xl flex flex-col justify-center items-center text-center h-64 transform transition-transform duration-300 hover:scale-105">
          <div className="absolute inset-0 bg-black bg-opacity-20 rounded-2xl p-4 flex flex-col justify-center items-center">
