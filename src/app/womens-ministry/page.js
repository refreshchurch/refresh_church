...
export default function MensMinistry() {
  return (
    <div className="container mx-auto px-8 sm:px-36 py-12">
      <h2 className="text-4xl font-bold text-gray-900 tracking-tighter sm:text-5xl md:text-6xl mb-12">Women's Ministry</h2>
      ...
      <div className="flex flex-col lg:flex-row items-center mb-12">
        <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
          ...
          <p className="text-gray-700 text-lg mb-6">
            Our Women's Ministry is a place where women of all ages come together to grow in faith, build strong relationships, and support one another on their spiritual journeys. From Bible studies to retreats and service projects, there's a place for you to connect and thrive.
          </p>
