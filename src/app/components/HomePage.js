...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <Head>
        <title>Refresh Church in Meridian, ID - Find Faith & Community</title>
        <meta
          name="description"
          content="Experience faith and community at Refresh Church, a non-denominational church in Meridian, ID. Join us Sundays @ 9 & 10:30 AM at Owyhee High School. Visit us!"
        />
      </Head>
      {/* Invisible h tags */}
