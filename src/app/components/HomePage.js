      ...
      <div className="flex flex-wrap gap-4 justify-center mb-4">
        <div className="bg-white shadow-md rounded-2xl w-full sm:aspect-17/9 aspect-square relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center flex-col">
            <h2 className="text-white sm:text-7xl text-5xl font-bold z-100 mb-2 mt-5"> Connect with us Online</h2>
            <div className="flex justify-end space-x-4 mt-3">
              <Link href='https://www.instagram.com/refreshchurchtv/' target="_blank" rel="noopener noreferrer">
                <svg className=" w-28 h-28 text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
              ...
              <Link href="https://www.facebook.com/myrefreshchurch" target="_blank" rel="noopener noreferrer">
                <svg className="pb-0.5 w-28 h-28 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M13.135 6H15V3h-1.865a4.147 4.147 0 0 0-4.142 4.142V9H7v3h2v9.938h3V12h2.021l.592-3H12V6.591A.6.6 0 0 1 12.592 6h.543Z" clipRule="evenodd" />
                </svg>
              </Link>

              <Link href="https://www.youtube.com/@refreshchurchtv" target="_blank" rel="noopener noreferrer">
                <svg className="w-32 h-32 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white shadow-md rounded-2xl w-full sm:aspect-17/9 aspect-square relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-0 flex items-center justify-center flex-col mt-[400px]">
            <Link href="/connect">
              ...
              <button className="bg-white text-black text-md font-semibold px-6 py-3 rounded-full hover:bg-primaryDark transition duration-300 ease-in-out">
                Learn More
              </button>
            </Link>
          </div>
