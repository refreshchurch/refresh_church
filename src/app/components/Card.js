      ...
      <div className="p-6 flex flex-col justify-between h-[250px]">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href={item.attributes.public_church_center_web_url || item.attributes.public_url}>
            <button className="flex items-center bg-primaryDark text-white text-md font-semibold py-3 px-7 rounded-full hover:bg-primary transition duration-300 ease-in-out">
              Register
