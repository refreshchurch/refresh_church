      ...
      <div className="mb-12">
        <div className="flex flex-col lg:flex-row-reverse items-center">
          <div className="lg:w-1/2 lg:pl-8 mb-8 lg:mb-0">
            ...
            Typically we have gatherings a few times per quarter at one of our homes, sharing food, and getting to know each other. These gatherings lend themselves to building community so that we can break off into smaller groups and take steps to see every person refreshed and every purpose discovered.
            </p>
          </div>
          <div className="lg:w-1/2">
